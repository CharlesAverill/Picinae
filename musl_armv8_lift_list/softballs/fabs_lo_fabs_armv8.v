...
Definition fabs_lo_fabs_armv8 : program := fun _ a => match a with

(* 0x00100000: fabs d0,d0 *)
| 1048576 => Some (4,
	Nop (* Unmodeled Op: FLOAT_ABS *) $;
...
Theorem welltyped: welltyped_prog arm8typctx fabs_lo_fabs_armv8. Proof. Picinae_typecheck. Qed.