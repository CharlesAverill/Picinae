...
*/
int passwordCheck_vuln(const unsigned char *stored, const unsigned char *user)
{
...
int main(void)
{
    ...
    rc = passwordCheck_vuln(correct, (const unsigned char *)"S3cr3t!");
    printf("match rc=%d\n", rc);

    rc = passwordCheck_vuln(correct, (const unsigned char *)"S3cr3x!");
    printf("mismatch rc=%d\n", rc);

    rc = passwordCheck_vuln(correct, (const unsigned char *)"S3cr3t!extra");
