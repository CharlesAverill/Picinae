/* Instrumented by RVS */
# 1 "/home/charles/Desktop/projects/rocq/Picinae/timing/examples/x86_wcet_comparison/rvs_x86_wcet_comparison/intermediate/rvs_instr_auto.h"
...
# 1 "/home/charles/Desktop/projects/rocq/Picinae/timing/examples/x86_wcet_comparison/rvs_x86_wcet_comparison/annotations-timing/rvs_instr.h"



# 1 "/home/charles/Desktop/projects/rocq/Picinae/timing/examples/x86_wcet_comparison/rvs_x86_wcet_comparison/annotations-timing/rvs_analysis.c"


# 1 "/home/charles/Desktop/projects/rocq/Picinae/timing/examples/x86_wcet_comparison/rvs_x86_wcet_comparison/rvslib-i5-7300u-timing/rvs_ipoint.h"
...
typedef int                t_rvs_int32;

typedef unsigned long long t_rvs_uint64;
typedef t_rvs_uint64     * t_rvs_uint64_ptr;
...
#else
typedef _Bool t_rvs_boolean;
#endif
#else 
    typedef bool t_rvs_boolean;
#endif
...
# 1 "/home/charles/Desktop/projects/rocq/Picinae/timing/examples/x86_wcet_comparison/rvs_x86_wcet_comparison/intermediate/pproc/_883089073__comparison_llsearch/linked_list.c"
# 0 "linked_list.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
# 574 "/usr/include/x86_64-linux-gnu/sys/cdefs.h" 3 4
/* If fortification mode, we warn about unused results of certain
   function calls which can lead to problems.  */
# 589 "/usr/include/x86_64-linux-gnu/sys/cdefs.h" 3 4
...
# 661 "/usr/include/x86_64-linux-gnu/sys/cdefs.h" 3 4
...
/* Copies attributes from the declaration or type referenced by
   the argument.  */
# 727 "/usr/include/x86_64-linux-gnu/sys/cdefs.h" 3 4
...
# 801 "/usr/include/x86_64-linux-gnu/sys/cdefs.h" 3 4
/* __glibc_macro_warning (MESSAGE) issues warning MESSAGE.  This is
   intended for use in preprocessor macros.

   Note: MESSAGE must be a _single_ string; concatenation of string
   literals is not supported.  */
# 814 "/usr/include/x86_64-linux-gnu/sys/cdefs.h" 3 4
...
# 832 "/usr/include/x86_64-linux-gnu/sys/cdefs.h" 3 4
...
# 859 "/usr/include/x86_64-linux-gnu/sys/cdefs.h" 3 4
/* Designates dealloc as a function to call to deallocate objects
   allocated by the declared function.  */
# 869 "/usr/include/x86_64-linux-gnu/sys/cdefs.h" 3 4
...
# 86 "/usr/lib/gcc/x86_64-linux-gnu/14/include/stddef.h" 3 4
...
# 111 "/usr/lib/gcc/x86_64-linux-gnu/14/include/stddef.h" 3 4
...
# 157 "/usr/lib/gcc/x86_64-linux-gnu/14/include/stddef.h" 3 4
...
# 241 "/usr/lib/gcc/x86_64-linux-gnu/14/include/stddef.h" 3 4
/* Wide character type.
...
/* Define this type if we are doing the whole job,
   or if we want this type in particular.  */
# 284 "/usr/lib/gcc/x86_64-linux-gnu/14/include/stddef.h" 3 4
/* On BSD/386 1.1, at least, machine/ansi.h defines _BSD_WCHAR_T_
   ...
   the same type." */
# 311 "/usr/lib/gcc/x86_64-linux-gnu/14/include/stddef.h" 3 4
/* FreeBSD 5 can't be handled well using "traditional" logic above
   since it no longer defines _BSD_RUNE_T_ yet still desires to export
   rune_t in some cases... */
# 329 "/usr/lib/gcc/x86_64-linux-gnu/14/include/stddef.h" 3 4
typedef int wchar_t;
# 396 "/usr/lib/gcc/x86_64-linux-gnu/14/include/stddef.h" 3 4
/* A null pointer constant.  */
# 414 "/usr/lib/gcc/x86_64-linux-gnu/14/include/stddef.h" 3 4
...
/* Any one of these symbols __need_* means that GNU libc
   wants us just to define one data type.  So don't define
   the symbols that indicate this file's entire job has been done.  */
# 46 "/usr/lib/gcc/x86_64-linux-gnu/14/include/stddef.h" 3 4
/* This avoids lossage on SunOS but only if stdtypes.h comes first.
   There's no way to win with the other order!  Sun lossage.  */
# 86 "/usr/lib/gcc/x86_64-linux-gnu/14/include/stddef.h" 3 4
/* Sequent's header files use _PTRDIFF_T_ in some conflicting way.
...
# 76 "/usr/include/x86_64-linux-gnu/bits/floatn.h" 3 4
/* Defined to a complex binary128 type if __HAVE_FLOAT128 is 1.  */
# 90 "/usr/include/x86_64-linux-gnu/bits/floatn.h" 3 4
...
# 102 "/usr/lib/gcc/x86_64-linux-gnu/14/include/limits.h" 3 4
...
# 204 "/usr/lib/gcc/x86_64-linux-gnu/14/include/limits.h" 3 4
...
void insert_after_pos_in_list(list_node* l, list_node* value, uint32_t position) {RVS_I(65535);{
   {if (l == 
# 17 "linked_list.c" 3 4
           ((void *)0) 
# 17 "linked_list.c"
                || value == 
# 17 "linked_list.c" 3 4
...
# 17 "linked_list.c"
 ...
 {{RVS_I(65534);return;}}RVS_I(10);}

   for (uint32_t i = 0; i < position; i++) {RVS_I(11);{
       {if (l->next == 
# 21 "linked_list.c" 3 4
                     ((void *)0)
# 21 "linked_list.c"
                         )
        {RVS_I(12);break;}RVS_I(13);}
       l = l->next;
   }}RVS_I(14);
   value->next = l->next;
   l->next = value;
...
int main(void) 
{
  RVS_Init();
       ...
       {
          int  rvs_output_return_tmp;
{RVS_I(65526);{
    for (int idx = 0; idx < 1000; idx++) {RVS_I(10);{
        /* Build a sorted linked list of size LIST_SIZE with ascending values */
        for (int i = 0; i < 128; i++) {RVS_I(11);{
            nodes[i].value = i;
...
# 80 "linked_list.c"
        ...
        list_node* new1 = &nodes[128 +1];
        new1->value = 9999;
        insert_after_pos_in_list(head, new1, rand() % 128);
...
# 90 "linked_list.c"
        ...
        list_node extra;
        extra.value = 128 + 500; // bigger than all but sentinel
        insert_in_sorted_list(head, &extra);
    }}

    {RVS_I(65525);return 
  (rvs_output_return_tmp =
0
  , RVS_Output(), rvs_output_return_tmp)
;}
}
       }
}
 ...
 * |  -c
 * |  /home/charles/Desktop/projects/rocq/Picinae/timing/examples/x86_wcet_comparison/rvs_x86_wcet_comparison/intermediate/rvs_instr_auto.h
 * |  -c
 * |  /home/charles/Desktop/projects/rocq/Picinae/timing/examples/x86_wcet_comparison/rvs_x86_wcet_comparison/annotations-timing/rvs_instr.h
 * |  -c
 * |  /home/charles/Desktop/projects/rocq/Picinae/timing/examples/x86_wcet_comparison/rvs_x86_wcet_comparison/annotations-timing/rvs_analysis.c
 * |  -c-c
 * |  /home/charles/Desktop/projects/rocq/Picinae/timing/examples/x86_wcet_comparison/rvs_x86_wcet_comparison/rvslib-i5-7300u-timing/rvs_ipoint.h
 * |  -c-cpp
 * |  /home/charles/Desktop/projects/rocq/Picinae/timing/examples/x86_wcet_comparison/rvs_x86_wcet_comparison/rvslib-i5-7300u-timing/rvs_ipoint.hpp
 * |  /home/charles/Desktop/projects/rocq/Picinae/timing/examples/x86_wcet_comparison/rvs_x86_wcet_comparison/intermediate/rvs_analysis.xsc
 * |  --xsc-dir
 * |  /home/charles/Desktop/projects/rocq/Picinae/timing/examples/x86_wcet_comparison/rvs_x86_wcet_comparison/intermediate/xscs/
 * |  --update
 * |  /home/charles/Desktop/projects/rocq/Picinae/timing/examples/x86_wcet_comparison/rvs_x86_wcet_comparison/results/x86_wcet_comparison-timing.rvd
 * |  --project
 * |  /home/charles/Desktop/projects/rocq/Picinae/timing/examples/x86_wcet_comparison/x86_wcet_comparison.rvsprj
 * |  --integration
 * |  i5-7300u-timing
 * |  --prepare-from-deferred-instrumentation
 * |  --mcdc-bitwise-ignore-c
 * |  --mcdc-bitwise-ignore-cpp
 * |  --instrumentation-mode
 * |  stored
 * |  --report-elab
 * |  --root
 * | "at function find_in_list(in l as pointer list_node, in key as uint32_t) return pointer list_node"
 * |  --root
 * | "at function insert_after_pos_in_list(in l as pointer list_node, in value as pointer list_node, in position as uint32_t)"
 * |  --root
 * | "at function insert_in_sorted_list(in l as pointer list_node, in value as pointer list_node)"
 * |  --dedupl-func
 * tz   : -300
 ********************************/
